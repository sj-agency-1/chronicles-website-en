...
metadata:
  title: 'Business Analytics: Stop Pouring Money Into a Leaky Bucket'
  description: "A professional business analyst's 15-year practice. Stop the haos, restore order and localize systemic failure. Turn intuitive decisions into management KPIs."

heroItems:
  - title: Strategic Analytics
    bgImage: ~/assets/images/skills/strategic-analytics.webp
...
The crisis management for that project is a whole other story, which I described in the article, [Crisis Management: Or the Story of How I Looked for EBITDA in the Dairy Rivers of the Far East, But Found It in a Yogurt Nobody Wanted to Make.](/skills/crisis-response)
