...
metadata:
  title: 'Digital Marketing: Antidote to Banally Metrics & Toxic Contractors | From Broker to Warlord'
  description: 'The true story of a stock broker turned Digital Warlord. 28 years of entrepreneurial experience: Learn to control execution, understand LTV, CAC, ROAS, and stop being manipulated by empty promises and banally metrics.'

heroItems:
  - title: Digital Performance
    bgImage: ~/assets/images/skills/digital-performance.webp
...
1. Special project on automotive portals: a branded animated car drives across the screen and emits smoke from the tailpipe (a banner) with a generic offer.
2. Outdoor advertising: a billboard with a 3D car model that crashed into the billboard itself. Next to it is the company name and an offer for insurance. Our task was to "virally spread" this creative on social media.
...
1. **What is the specific business goal of the advertising campaign?** (E.g., "I want to increase sales in the online store by 25% in 3 months compared to the previous similar period.")
2. **Describe the TA in detail.** It is important to describe their interests, identify insights, intents, decision-making paths, and their real "pains."
3. **How will you measure success?** Which metrics will you monitor? Build a clear, understandable funnel.
4. **How will the new advertising campaign fit into the brand's communication strategy?**
5. **How and when did you conduct A-B-C testing of hypotheses on audience segments?** Results?
